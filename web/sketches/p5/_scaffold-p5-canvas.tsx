...
const P5CanvasDisplay: LXLT_P5CanvasDisplay = (
  ...
  // _________________________________________________
  // Update Character
  const updateCharacter = (char: LXLT_P5CanvasChar, idx: number) => {
  ...
  // _________________________________________________
  // Update Copies
  const updateCopies = (char: LXLT_P5CanvasChar, idx: number) => {
  ...
  p.draw = () => {
    ...
    if (H && W) {
      ...
      characters.map((char: LXLT_P5CanvasChar, idx: number) => {
        p.scale(1, 1);
