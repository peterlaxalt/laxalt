...
/* harmony import */ var _svg_DharmaLaxalt__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../_svg/DharmaLaxalt */ "./components/_svg/DharmaLaxalt.tsx");
// Imports
...
})(["&.", "{--frameEdgeSize:3rem;.", "__inner{width:100vw;height:100vh;position:relative;}.", "__type,.", ",.", "__frame{position:absolute;top:0;left:0;right:0;bottom:0;width:100%;height:100%;}.", "{top:var(--frameEdgeSize);left:var(--frameEdgeSize);right:var(--frameEdgeSize);bottom:var(--frameEdgeSize);width:calc(100% - (var(--frameEdgeSize) * 2));height:calc(100% - (var(--frameEdgeSize) * 2));}.", "__frame{background:cyan;}}"], InteractiveFrameHeaderClassName, InteractiveFrameHeaderClassName, InteractiveFrameHeaderClassName, _svg_DharmaLaxalt__WEBPACK_IMPORTED_MODULE_3__["DharmaLaxaltClassName"], InteractiveFrameHeaderClassName, _svg_DharmaLaxalt__WEBPACK_IMPORTED_MODULE_3__["DharmaLaxaltClassName"], InteractiveFrameHeaderClassName);

/***/ })

})
//# sourceMappingURL=index.js.e124bea0696df4251278.hot-update.js.map