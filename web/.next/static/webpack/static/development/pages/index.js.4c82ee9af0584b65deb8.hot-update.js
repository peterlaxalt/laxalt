...
/* harmony import */ var _svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../_svg/DharmaType/styles.scss */ "./components/_svg/DharmaType/styles.scss.tsx");
...
function (_React$PureComponent) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_6__["default"])(DharmaCounter, _React$PureComponent);
  ...
  function DharmaCounter(props) {
    ...
    _this.incrementLetterCount = _this.incrementLetterCount.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this));
    return _this;
  }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(DharmaCounter, [{
    ...
    value: function render() {
      ...
      return __jsx(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_8__["DharmaTypeStyle"], {
        xmlns: "http://www.w3.org/2000/svg",
        viewBox: "0 0 ".concat(viewBoxWidth, " ").concat(viewBoxHeight),
        preserveAspectRatio: "none",
        className: "".concat(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_8__["DharmaTypeClassName"], " ").concat(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_8__["DharmaTypeClassName"], "--couter"),
        style: Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, "--".concat(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_8__["DharmaTypeClassName"], "-font-size"), "".concat(viewBoxHeight, "px")),
        __source: {
        ...
        console.count(new Array(_char.count));

        function renderChar(count, increment) {
          for (var i = 0; i <= count; i++) {
            console.count("LOOP");
            return __jsx("g", {
              className: "".concat(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_8__["DharmaTypeClassName"], "__character-wrapper"),
              "data-char-count": _char.count,
              key: idx,
              ...
              className: "".concat(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_8__["DharmaTypeClassName"], "__character"),
              transform: "translate(".concat(characterWidth * idx, " ").concat(viewBoxHeight * characterVerticalTranslation, ") scale(").concat(characterHorizontalScale, ", ").concat(characterVerticalScale, ")"),
              style: Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, "--".concat(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_8__["DharmaTypeClassName"], "-key"), idx),
              __source: {
                fileName: _jsxFileName,
                lineNumber: 170
              },
              ...
              className: "".concat(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_8__["DharmaTypeClassName"], "__letter"),
              __source: {
                fileName: _jsxFileName,
                lineNumber: 179
              },
        ...
        return renderChar(_char.count, _this2.incrementLetterCount);
      })));
    }
  }]);
...
//# sourceMappingURL=index.js.4c82ee9af0584b65deb8.hot-update.js.map