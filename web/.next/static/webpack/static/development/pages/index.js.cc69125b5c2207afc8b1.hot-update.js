      ...
      return __jsx(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_9__["DharmaTypeStyle"], {
        ...
        return countArray.map(function (duplicate, idxx) {
          return __jsx("g", {
            ...
            transform: "translate(".concat(characterWidth * idx, " ").concat(viewBoxHeight * (characterVerticalTranslation * (duplicate = 0 ? undefined : duplicate)), ") scale(").concat(characterHorizontalScale, ", ").concat(characterVerticalScale, ")"),
...
//# sourceMappingURL=index.js.cc69125b5c2207afc8b1.hot-update.js.map