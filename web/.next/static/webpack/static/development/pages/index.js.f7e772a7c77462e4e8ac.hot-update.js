...
function (_React$PureComponent) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(DharmaCounter, [{
    ...
    value: function incrementOffsetCount() {
      this.setState({
        offsetCount: this.state.offsetCount + 1
      });
      return;
    }
  }, {
    ...
    value: function offsetCountTimer() {
      ...
      window.setInterval(function () {
        return _this3.updateLetterCount(generateRandomInteger(0, _this3.state.characters.length));
      }, 3000);
    }
  }, {
    key: "render",
...
//# sourceMappingURL=index.js.f7e772a7c77462e4e8ac.hot-update.js.map