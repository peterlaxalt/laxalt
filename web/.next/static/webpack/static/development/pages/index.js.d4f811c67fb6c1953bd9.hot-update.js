      ...
      return __jsx(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_9__["DharmaTypeStyle"], {
        ...
        return countArray.map(function (duplicate, idxx) {
          ...
          return __jsx("g", {
            ...
            transform: "translate(".concat(characterWidth * idx, " ").concat(viewBoxHeight * characterVerticalTranslation, ") scale(").concat(characterHorizontalScale, ", ").concat(characterVerticalScale * adjustedDuplicate, ")"),
...
//# sourceMappingURL=index.js.d4f811c67fb6c1953bd9.hot-update.js.map