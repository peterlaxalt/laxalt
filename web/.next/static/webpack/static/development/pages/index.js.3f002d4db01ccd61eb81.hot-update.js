    ...
    value: function render() {
      ...
      return __jsx(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_9__["DharmaTypeStyle"], {
        ...
        return countArray.map(function (duplicate, idxx) {
          var adjustedDuplicate = duplicate + 1;
          return __jsx("g", {
            ...
            transform: "translate(".concat(characterWidth * idx, " ").concat(viewBoxHeight * characterVerticalTranslation, ") scale(").concat(characterHorizontalScale * adjustedDuplicate, ", ").concat(characterVerticalScale * adjustedDuplicate, ")"),
...
//# sourceMappingURL=index.js.3f002d4db01ccd61eb81.hot-update.js.map