...
function (_React$PureComponent) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(DharmaCounter, [{
    ...
    value: function incrementOffsetCount() {
      this.setState({
        offsetCount: this.state.offsetCount < 7 ? this.state.offsetCount + 1 : 2
      });
      return;
    }
  }, {
...
var DharmaCounterDisplay = function DharmaCounterDisplay(props) {
  ...
  return __jsx(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_11__["DharmaTypeStyle"], {
    ...
    return countArray.map(function (duplicate, idxx) {
      ...
      return __jsx("g", {
        className: "".concat(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_11__["DharmaTypeClassName"], "__character-wrapper ").concat(outlined && Math.random() <= 0.5 ? "".concat(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_11__["DharmaTypeClassName"], "__character-wrapper--hidden") : ""),
        "data-char-id": idx,
...
//# sourceMappingURL=index.js.fe1fd5df97dc765fe098.hot-update.js.map