      ...
      if (H && W) {
        characters.map(function (_char, idx) {
          ...
          countArray.map(function (duplicate, idxx) {
            ...
            p.text(_char.letter, previousHorizontalTranslation(idx), duplicateVerticalPosition * verticalScale);
            p.pop();
          });
        });
      }
...
//# sourceMappingURL=dharma.js.f6acf92a993e04b3528f.hot-update.js.map