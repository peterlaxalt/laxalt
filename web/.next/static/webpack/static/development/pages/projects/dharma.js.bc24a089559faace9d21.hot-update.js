...
var DharmaCanvasDisplay = function DharmaCanvasDisplay(W, H, ID, BG) {
  return function (p) {
    ...
    var previousHorizontalTranslation = function previousHorizontalTranslation(idx) {
      return characterWidth * idx + characterWidth / 2 + strokeWidth * 2 * renderCount * 1;
    };
        ...
        characters.map(function (_char, idx) {
          ...
          if (p.mouseIsPressed) {
            return countArray.map(function (duplicate, idxx) {
              previousVerticalTranslation = H / 2.25 + strokeWidth * 2 * renderCount * -1;
...
//# sourceMappingURL=dharma.js.bc24a089559faace9d21.hot-update.js.map