  ...
  return function (p) {
    ...
    var updateCopies = function updateCopies(_char2, idx) {
      if (_char2.copies < maxCount && _char2.isIncrementing) {
        ...
        previousCopyUpdateTime = p.millis();
      } else if (_char2.copies > minCount && _char2.isDecrementing) {
        characters[idx] = _objectSpread({}, _char2, {
          copies: _char2.copies - 1,
          isDecrementing: true
        });
    ...
    p.draw = function () {
      ...
      if (H && W) {
        ...
        characters.map(function (_char3, idx) {
          ...
          if (p.millis() - previousCopyUpdateTime > 3000) {
...
//# sourceMappingURL=dharma.js.a1427240290edde73a83.hot-update.js.map