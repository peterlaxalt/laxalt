      ...
      if (H && W) {
        characters.map(function (_char, idx) {
          ...
          countArray.map(function (duplicate, idxx) {
            ...
            var verticalPosition = // previousVerticalTranslation = H / 2.25;
            p.push();
            p.scale(1, verticalScale);
            p.text(_char.letter, previousHorizontalTranslation(idx), H / 2.25 * idx);
            p.pop();
          });
        });
      }
...
//# sourceMappingURL=dharma.js.725d98df980937064a39.hot-update.js.map