      ...
      if (H && W) {
        characters.map(function (_char, idx) {
          ...
          countArray.map(function (duplicate, idxx) {
            ...
            p.text(_char.letter, previousHorizontalTranslation(idx), duplicateVerticalPosition * (verticalScale * 10));
            p.pop();
          });
        });
      }
...
//# sourceMappingURL=dharma.js.f3dd7cc1a2d77831f109.hot-update.js.map