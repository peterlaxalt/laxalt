...
var DharmaCanvasDisplay = function DharmaCanvasDisplay(W, H, ID, BG) {
  return function (p) {
    ...
    p.draw = function () {
      ...
      p.textLeading(0);
      p.textSize(characterSize); // p.textAlign(p.CENTER, p.CENTER);
      ...
      if (H && W) {
        characters.map(function (_char, idx) {
          ...
          countArray.map(function (countNumber, idxx) {
            ...
            var duplicateVerticalPosition = 0 + characterSize / _char.count;
            p.push();
...
//# sourceMappingURL=dharma.js.c5a40a38b89753980b91.hot-update.js.map