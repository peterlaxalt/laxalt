    ...
    p.draw = function () {
      ...
      if (H && W) {
        characters.map(function (_char, idx) {
          ...
          console.log("p.millis() - previousTime", p.millis() - previousTime);

          if (randomPick && p.millis() - previousTime > 6000) {
...
//# sourceMappingURL=dharma.js.53a94a8046d71325ecb2.hot-update.js.map