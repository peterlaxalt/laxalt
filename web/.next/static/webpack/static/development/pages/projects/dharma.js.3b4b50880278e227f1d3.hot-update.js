        ...
        characters.map(function (_char2, idx) {
          ...
          countArray.map(function (countNumber, idxx) {
            ...
            copiesArray.map(function (copyNumber, idxxx) {
              var horizontalTranslate = copyNumber !== 1 ? (previousHorizontalTranslation(idx) + strokeOffset * copyNumber) * (p.mouseX / 100) : previousHorizontalTranslation(idx) + strokeOffset * copyNumber;
              var verticalTranslate = copyNumber !== 1 ? (duplicateVerticalPosition - strokeOffset * copyNumber) * (p.mouseY / 100) : duplicateVerticalPosition - strokeOffset * copyNumber;
              p.push();
...
//# sourceMappingURL=dharma.js.3b4b50880278e227f1d3.hot-update.js.map