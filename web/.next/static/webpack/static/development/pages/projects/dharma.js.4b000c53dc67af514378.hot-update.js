      ...
      if (H && W) {
        characters.map(function (_char, idx) {
          ...
          countArray.map(function (duplicate, idxx) {
            ...
            p.text(_char.letter, previousHorizontalTranslation(idx), duplicateVerticalPosition * (verticalScale * 100));
            p.pop();
          });
        });
      }
...
//# sourceMappingURL=dharma.js.4b000c53dc67af514378.hot-update.js.map