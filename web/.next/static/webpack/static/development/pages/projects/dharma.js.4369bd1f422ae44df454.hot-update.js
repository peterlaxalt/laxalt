...
var DharmaCanvasDisplay = function DharmaCanvasDisplay(W, H, ID, BG) {
  return function (p) {
    ...
    var previousCopiesVisibleTime = 0; // ____________________________
    // Strokes
      ...
      if (H && W) {
        ...
        characters.map(function (_char3, idx) {
          ...
          countArray.map(function (countNumber, idxx) {
            ...
            var randomCopyPick = Math.random() <= 0.5; // let copyTimer = p.millis() - previousCopiesVisibleTime > 2000;
            ...
            copiesArray.map(function (copyNumber, idxxx) {
              ...
              if (isFirstCount) {
                ...
                p.pop();
                isFirstCount = false;
              } else if (randomCopyPick && p.millis() - _char3.copiesLastVisible > 2000) {
                p.push();
                p.scale(1, verticalScale);
                p.text(_char3.letter, horizontalTranslate, verticalTranslate);
                p.pop();
                characters[idx] = _objectSpread({}, _char3, {
                  copiesLastVisible: p.millis()
                });
              } else {
                return null;
              }
...
//# sourceMappingURL=dharma.js.4369bd1f422ae44df454.hot-update.js.map