      ...
      if (H && W) {
        characters.map(function (_char, idx) {
          ...
          countArray.map(function (countNumber, idxx) {
            ...
            var verticalScale = 1 * (p.mouseY / 100); // let magnifiedCharSize = characterSize * (verticalScale * 100);
            ...
            p.push();
            p.scale(1 * (p.mouseX / 100), verticalScale);
...
//# sourceMappingURL=dharma.js.e2986c1b8a8bd3c8ccd7.hot-update.js.map