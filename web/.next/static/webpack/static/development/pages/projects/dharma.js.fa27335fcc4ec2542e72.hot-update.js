        ...
        characters.map(function (_char2, idx) {
          ...
          countArray.map(function (countNumber, idxx) {
            ...
            copiesArray.map(function (copyNumber, idxxx) {
              var horizontalTranslate = copyNumber !== 1 ? previousHorizontalTranslation(idx) + strokeOffset / (p.mouseX / 100) * copyNumber : previousHorizontalTranslation(idx) + strokeOffset * copyNumber;
              var verticalTranslate = copyNumber !== 1 ? duplicateVerticalPosition - strokeOffset / (p.mouseX / 100) * copyNumber : duplicateVerticalPosition - strokeOffset * copyNumber;
              p.push();
...
//# sourceMappingURL=dharma.js.fa27335fcc4ec2542e72.hot-update.js.map