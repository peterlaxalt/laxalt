...
var DharmaCanvasDisplay = function DharmaCanvasDisplay(W, H, ID, BG) {
  return function (p) {
    ...
    var characterSize = H; // ____________________________
    // Counts
      ...
      if (H && W) {
        characters.map(function (_char, idx) {
          ...
          countArray.map(function (countNumber, idxx) {
            ...
            var verticalScale = 1; // let magnifiedCharSize = characterSize * (verticalScale * 100);
...
//# sourceMappingURL=dharma.js.a4753c1a3e9567769a80.hot-update.js.map