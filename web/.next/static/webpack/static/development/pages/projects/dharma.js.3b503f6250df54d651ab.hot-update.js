      ...
      if (H && W) {
        characters.map(function (_char, idx) {
          ...
          countArray.map(function (duplicate, idxx) {
            ...
            var duplicateVerticalPosition = (H / 2.25 + characterSize * 0.01) * 3; // console.log("duplicateVerticalPosition", duplicateVerticalPosition);

            console.log("H", H); // console.log("characterSize", characterSize);
...
//# sourceMappingURL=dharma.js.3b503f6250df54d651ab.hot-update.js.map