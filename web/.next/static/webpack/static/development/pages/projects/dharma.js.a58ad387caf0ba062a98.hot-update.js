          ...
          countArray.map(function (countNumber, idxx) {
            ...
            copiesArray.map(function (copyNumber, idxxx) {
              ...
              if (isFirstCount) {
                ...
                p.pop();
                isFirstCount = false;
              } else if (_char3.copiesAreVisible) {
                if (p.millis() - _char3.copiesLastVisible > 2000) {
                  p.push();
                  p.scale(1, verticalScale);
                  p.text(_char3.letter, horizontalTranslate, verticalTranslate);
                  p.pop();
                  characters[idx] = _objectSpread({}, _char3, {
                    copiesLastVisible: p.millis() // copiesAreVisible: false,
...
//# sourceMappingURL=dharma.js.a58ad387caf0ba062a98.hot-update.js.map