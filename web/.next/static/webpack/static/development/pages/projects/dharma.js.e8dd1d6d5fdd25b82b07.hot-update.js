      ...
      if (H && W) {
        characters.map(function (_char, idx) {
          ...
          countArray.map(function (duplicate, idxx) {
            ...
            var verticalScale = 1 / _char.count; // let duplicateVerticalPosition = (characterSize * verticalScale * idxx) * char.count;

            var duplicateVerticalPosition = (H / 2.25 + characterSize * 0.01) * idxx; // console.log("duplicateVerticalPosition", duplicateVerticalPosition);
            // console.log("H", H);
...
//# sourceMappingURL=dharma.js.e8dd1d6d5fdd25b82b07.hot-update.js.map