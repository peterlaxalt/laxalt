      ...
      if (H && W) {
        characters.map(function (_char, idx) {
          ...
          countArray.map(function (duplicate, idxx) {
            ...
            var verticalScale = .5; // let duplicateVerticalPosition = (characterSize * verticalScale * idxx) * char.count;

            var duplicateVerticalPosition = H / 2.25 + characterSize * .01;
            console.log(duplicateVerticalPosition); // let duplicateVerticalPosition = (H / 2.25);
...
//# sourceMappingURL=dharma.js.7b4b15930fc5b31c8ea8.hot-update.js.map