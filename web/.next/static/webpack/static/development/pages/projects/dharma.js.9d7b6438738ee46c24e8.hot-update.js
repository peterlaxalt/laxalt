      ...
      if (H && W) {
        characters.map(function (_char, idx) {
          ...
          countArray.map(function (duplicate, idxx) {
            ...
            var duplicateVerticalPosition = H / 2.25 + characterSize * 0.01;
            console.log("duplicateVerticalPosition", duplicateVerticalPosition);
            console.log("H", H);
            console.log("characterSize", characterSize); // let duplicateVerticalPosition = (H / 2.25);
...
//# sourceMappingURL=dharma.js.9d7b6438738ee46c24e8.hot-update.js.map