      ...
      if (H && W) {
        characters.map(function (_char, idx) {
          ...
          countArray.map(function (duplicate, idxx) {
            ...
            var magnifiedCharSize = characterSize * _char.count; // let duplicateVerticalPosition = (characterSize * verticalScale * idxx) * char.count;

            var duplicateVerticalPosition = (H / 2.25 + magnifiedCharSize) * idxx;
            console.log("duplicateVerticalPosition", duplicateVerticalPosition); // console.log("H", H);
...
//# sourceMappingURL=dharma.js.95731d9f0c189a8b3356.hot-update.js.map