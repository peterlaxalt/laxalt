...
var DharmaCanvasDisplay = function DharmaCanvasDisplay(W, H, ID, BG) {
  return function (p) {
    ...
    var maxCopies = 30; // let minCopies = 1;
    // ____________________________
    // Translation
        ...
        characters.map(function (_char, idx) {
          ...
          if (randomPick) {
            characters[idx] = _objectSpread({}, _char, {
              count: _char.count < maxCopies ? _char.count + 1 : _char.count
            });
          }
...
//# sourceMappingURL=dharma.js.37054d5ad2feb6cd4281.hot-update.js.map