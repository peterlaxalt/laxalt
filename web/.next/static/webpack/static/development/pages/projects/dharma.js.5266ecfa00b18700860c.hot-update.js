      ...
      if (H && W) {
        characters.map(function (_char, idx) {
          ...
          countArray.map(function (duplicate, idxx) {
            var adjustedDuplicate = _char.count > 1 ? _char.count : duplicate + 1; // let verticalScale = char.count > 0 ? H / char.count / H : 1;

            var verticalScale = 1 / _char.count;
            var magnifiedCharSize = characterSize * (verticalScale * 100); // let duplicateVerticalPosition = (characterSize * verticalScale * idxx) * char.count;

            var duplicateVerticalPosition = H / 2.25 + magnifiedCharSize * adjustedDuplicate; // console.log("duplicateVerticalPosition", duplicateVerticalPosition);
            // console.log("H", H);
            // console.log("characterSize", characterSize);
            // let duplicateVerticalPosition = (H / 2.25);
...
//# sourceMappingURL=dharma.js.5266ecfa00b18700860c.hot-update.js.map