    ...
    p.draw = function () {
      ...
      if (H && W) {
        characters.map(function (_char, idx) {
          ...
          var verticalDivisble = 10; // let verticalPosition: number = H / verticalDivisble;
          // p.scale(1, 0.5);
          ...
          countArray.map(function (duplicate, idxx) {
            ...
            var duplicateVerticalPosition = characterSize * verticalScale * idxx;
            p.push();
...
//# sourceMappingURL=dharma.js.41ca7fc21292f9e29b77.hot-update.js.map