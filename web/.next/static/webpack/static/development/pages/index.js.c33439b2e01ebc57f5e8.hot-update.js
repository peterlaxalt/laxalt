...
})(["&.", "{--frameEdgeSize:3rem;.", "__inner{width:100vw;height:100vh;position:relative;}.", ",.", "__frame{position:absolute;top:0;left:0;right:0;bottom:0;width:100%;height:100%;}.", "__type{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);fill:", ";width:calc(100% - (var(--frameEdgeSize) * 2));height:calc(100% - (var(--frameEdgeSize) * 2));.", "{top:0;left:0;right:0;bottom:0;width:100%;height:100%;}}.", "__frame{&__y-axis,&__x-axis{position:absolute;overflow:hidden;left:50%;top:50%;}&__y-axis{width:100vw;height:100vh;transform:translate(-50%,-50%);}&__x-axis{width:100vh;height:100vw;transform:translate(-50%,-50%) rotate(90deg);}&__edge{font-size:calc(var(--frameEdgeSize) * 0.75);text-transform:uppercase;line-height:0;.", "__frame-items{list-style-type:none;color:", ";width:100%;height:var(--frameEdgeSize);display:flex;align-items:center;justify-content:flex-start;li{margin-right:calc(var(--frameEdgeSize) / 2);}}.", "__marquee-container{flex-shrink:0;flex-grow:100%;display:flex;justify-content:flex-start;flex-wrap:nowrap;position:relative;overflow:hidden;.", "__frame-items{display:flex;flex-wrap:nowrap;white-space:nowrap;flex-shrink:0;flex-grow:100%;animation:marquee 10s linear infinite;border:1px solid black;li{width:auto;flex-shrink:0;white-space:nowrap;}}}&--top,&--bottom,&--left,&--right{position:absolute;overflow:hidden;}&--top,&--right{.", "__frame-items{padding-top:calc(var(--frameEdgeSize) / 6);}}&--bottom,&--left{.", "__frame-items{padding-bottom:calc(var(--frameEdgeSize) / 6);}}&--top,&--bottom{width:calc(100vw - var(--frameEdgeSize));}&--left,&--right{width:calc(100vh - var(--frameEdgeSize));}&--top{top:0;left:var(--frameEdgeSize);}&--bottom{bottom:0;right:var(--frameEdgeSize);}&--right{top:0;left:var(--frameEdgeSize);}&--left{bottom:0;left:0;}}}}"], InteractiveFrameHeaderClassName, InteractiveFrameHeaderClassName, _svg_DharmaType__WEBPACK_IMPORTED_MODULE_3__["DharmaTypeClassName"], InteractiveFrameHeaderClassName, InteractiveFrameHeaderClassName, _constants_Theme__WEBPACK_IMPORTED_MODULE_1__["Theme"].Color.Galaxy, _svg_DharmaType__WEBPACK_IMPORTED_MODULE_3__["DharmaTypeClassName"], InteractiveFrameHeaderClassName, InteractiveFrameHeaderClassName, _constants_Theme__WEBPACK_IMPORTED_MODULE_1__["Theme"].Color.Galaxy, InteractiveFrameHeaderClassName, InteractiveFrameHeaderClassName, InteractiveFrameHeaderClassName, InteractiveFrameHeaderClassName);

/***/ })

})
//# sourceMappingURL=index.js.c33439b2e01ebc57f5e8.hot-update.js.map