      ...
      return __jsx(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_9__["DharmaTypeStyle"], {
        ...
        return countArray.map(function (duplicate, idxx) {
          return __jsx("g", {
            ...
            transform: "translate(".concat(characterWidth * idx, " ").concat(viewBoxHeight * characterVerticalTranslation, ") scale(").concat(characterHorizontalScale, ", ").concat(characterVerticalScale * (duplicate + .5), ")"),
...
//# sourceMappingURL=index.js.8d1985837af9261f65f9.hot-update.js.map