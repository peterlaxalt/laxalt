...
})(["&.", "{--frameEdgeSize:3rem;.", "__inner{width:100vw;height:100vh;position:relative;}.", "__type,.", ",.", "__frame{position:absolute;top:0;left:0;right:0;bottom:0;width:100%;height:100%;}.", "{top:var(--frameEdgeSize);left:var(--frameEdgeSize);right:var(--frameEdgeSize);bottom:var(--frameEdgeSize);width:calc(100% - (var(--frameEdgeSize) * 2));height:calc(100% - (var(--frameEdgeSize) * 2));}.", "__frame{background:mediumseagreen;&__edge{font-size:3rem;text-transform:uppercase;ul{list-style-type:none;width:100%;display:flex;align-items:center;justify-content:flex-start;}&--right,&--left{display:none;}}}}"], InteractiveFrameHeaderClassName, InteractiveFrameHeaderClassName, InteractiveFrameHeaderClassName, _svg_DharmaType__WEBPACK_IMPORTED_MODULE_3__["DharmaTypeClassName"], InteractiveFrameHeaderClassName, _svg_DharmaType__WEBPACK_IMPORTED_MODULE_3__["DharmaTypeClassName"], InteractiveFrameHeaderClassName);

/***/ })

})
//# sourceMappingURL=index.js.0c888199c43b69257caa.hot-update.js.map