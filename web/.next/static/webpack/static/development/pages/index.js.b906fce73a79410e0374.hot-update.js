      ...
      return __jsx(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_9__["DharmaTypeStyle"], {
        ...
        return countArray.map(function (number, idxx) {
          return __jsx("g", {
            ...
            transform: "translate(".concat(characterWidth * idx, " ").concat(viewBoxHeight * (characterVerticalTranslation * number), ") scale(").concat(characterHorizontalScale, ", ").concat(characterVerticalScale, ")"),
...
//# sourceMappingURL=index.js.b906fce73a79410e0374.hot-update.js.map