      ...
      return __jsx(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_9__["DharmaTypeStyle"], {
        ...
        return countArray.map(function (duplicate, idxx) {
          return __jsx("g", {
            ...
            transform: "translate(".concat(characterWidth * idx, " ").concat(viewBoxHeight * characterVerticalTranslation, ") scale(").concat(characterHorizontalScale, ", ").concat(characterVerticalScale * (duplicate + 1), ")"),
...
//# sourceMappingURL=index.js.56d86a860be90f265aba.hot-update.js.map