      ...
      return __jsx(_svg_DharmaType_styles_scss__WEBPACK_IMPORTED_MODULE_9__["DharmaTypeStyle"], {
        ...
        return countArray.map(function (duplicate, idxx) {
          return __jsx("g", {
            ...
            transform: "translate(".concat(characterWidth * idx, " ").concat(viewBoxHeight * (characterVerticalTranslation * 2), ") scale(").concat(characterHorizontalScale, ", ").concat(characterVerticalScale, ")"),
...
//# sourceMappingURL=index.js.c45fa4f0fa6ae6132a31.hot-update.js.map