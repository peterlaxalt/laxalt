...
class three_water_distort_canvas_ThreeWaterCanvasClass {
  ...
  constructor(options) {
    ...
    this.camera = new external_three_["PerspectiveCamera"](45, window.innerWidth / window.innerHeight, 0.1, 10000);
    ...
    this.geometry = new external_three_["PlaneBufferGeometry"](60, 35, 1, 1);
...
const P5Wrapper = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => Promise.resolve(/* import() */).then(__webpack_require__.t.bind(null, "nhmZ", 7)), {
...
class P5Page extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(props) {
    super(props);
...
const ThreeCanvas = (container, CanvasElement, CanvasTheme) => {
  _constants_site_Settings__WEBPACK_IMPORTED_MODULE_1__[/* __DEBUG__ */ "b"] && console.log("🤙 Three.js Canvas received:", CanvasElement);
