...
export const ContactPageClassName = "route__contact";
 ...
 *
 */
const ContactPage: NextPage<LMNTS_LocationsFrontPage> = () => {
  return (
    <SimpleContentTemplate addClass={`${ContactPageClassName}`}>
      <MarqueeRow
        hasSidebar={false}
        style={{ marginTop: CssFrameSizeWithBorderString }}
        strings={["LET'S TALK", "LET'S TALK"]}
      />
